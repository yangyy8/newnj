        ...
        <el-col :span="22" class="br pr-20">
          <el-row align="center"   :gutter="2">
            <el-col  :sm="24" :md="12" :lg="8"   class="input-item">
              ...
              <el-input placeholder="请输入内容" size="small" v-model="pd.ENGLISHNAME"   class="input-input"></el-input>
            </el-col>
                <el-col  :sm="24" :md="12" :lg="8"  class="input-item">
...
export default {
  ...
  methods: {
    ...
    getList(currentPage, showCount, pd) {
      ...
      this.$api.post(this.Global.aport5+'/esLxsController/getResultListByParams', p,
        r => {
