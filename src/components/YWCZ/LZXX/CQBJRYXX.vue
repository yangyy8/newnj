        ...
        <el-col :span="22" class="br pr-20">
          <el-row align="center"   :gutter="2">
            ...
            <el-col :span="2" class="down-btn-area">
              ...
              <el-button type="primary" size="small" @click="$router.push({name:'LZCQBJ'})">返回</el-button>
            </el-col>
          </el-row>
    </div>
    <div class="yycontent">
          ...
          <el-table
           ...
           <el-table-column
             label="操作" width="70">
             <template slot-scope="scope">
               <el-button type="text"  class="a-btn"  :title="(cdt.type == 'YCL'||cdt.type == 'ZS')?'详情':'编辑'"  :icon="(cdt.type == 'YCL'||cdt.type == 'ZS')?'el-icon-tickets':'el-icon-edit-outline'" @click="details(scope.row)"></el-button>
             </template>
           </el-table-column>
         </el-table>
        ...
        <el-form :model="form"  class="crcolor" style="padding:10px;line-height:35px;">
          ...
          <el-row  :gutter="3">
            ...
            <el-col :span="24" >
              ...
              <el-input type="textarea" placeholder="请输入处理意见" size="small" v-model="form.clyj"  class="yy-input-input" style="width:86.8%!important" :disabled="cdt.type == 'YCL'||cdt.type == 'ZS'"></el-input>
            </el-col>
          </el-row>
         </el-form>
...
export default {
  ...
  methods: {
   ...
   details(i){
     this.form.clyj='';
     this.form=i;
     if(this.cdt.type == 'YCL'||this.cdt.type == 'ZS'){
       let p={
         pd:{
           uuid:i.uuid,
         },
       ...
       this.$api.post(this.Global.aport3+'/lzbjxx/getLzbjxx',p,
        r =>{
          if(r.success){
            this.$set(this.form,'clyj',r.data.clyj)
          }
        })
     }
   ...
   titleShow(e,el){
    ...
    getList(currentPage, showCount, pd) {
      ...
      var url = this.Global.aport2 + '/lzbjxx/getLzbjxxList';
      this.$api.post(url, p,
        r => {
    ...
    download(){
      ...
      this.$api.post(this.Global.aport2 + '/lzbjxx/exportLzbjxxList',p,
       r =>{
         this.downloadM(r)
       },e=>{},{},'blob')
    },
