    ...
    export default {
      ...
      methods: {
        ...
        getSLDW(){
          ...
          this.$api.post(this.Global.aport5+'/dwController/getSldwList',p,
           r =>{
             if(r.success){
        ...
        downloadM (data) {
            ...
            link.href = url
            link.setAttribute('download', '案件综合分析列表'+this.format(new Date(),'yyyyMMddhhmmss')+'.xls')
        ...
        getList(currentPage, showCount, pd) {
          ...
          this.$api.post(this.Global.aport5+'/ajController/getCount', p,
            r => {
