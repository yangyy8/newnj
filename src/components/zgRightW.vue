      ...
      <div class="rw-con-con">
        <div class="rr-child">
          <div class="topLeft">
            ...
            <div class = "tkchart1" style="width:100%">
              <div id = "tkecharts" style = "width: 100%;height:350px"></div>
            </div>
          </div>
          <div class="topRight">
            <div class="tl-title sim-title text-shadow">
            ...
            <div class="tr-con">
              <div class="tr-conOne">
                <div class="tl-title sim-title text-shadow" style="font-size:28px">
                  涉恐人员数量
                </div>
                <div class = "skchart1" style="width:100%;margin-top: 15px;">
                  <div id = "skecharts" style = "width: 100%;height:250px"></div>
                </div>
              </div>
              <div class="tr-conTwo">
                <div class="tl-title sim-title text-shadow" style="font-size:28px;width:70%">
                  不准出境人员数量
                </div>
                <div class = "bzcjchart1" style="width:100%;margin-top: 15px;">
                  <div id = "buzcjecharts" style = "width: 100%;height:250px"></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="t-mtt">
          ...
          <div class = "zdgzchart1" style="width:100%">
            <div id = "zdgzecharts" style = "width: 100%;height:300px"></div>
          </div>
        </div>
      </div>
    </div>
