        ...
        <div class="fxleft">
             ...
             <div class="fxcont" v-if="show">
                <el-row :gutter="1">
                  ...
                  <el-col :span="24">
                      <span class="yy-input-text">中心点：</span>
                      <el-input placeholder="请输入内容" size="small" v-model="pd.center"   class="input-input"></el-input>
                  </el-col>
                  <el-col :span="24">
                      <span class="yy-input-text">半径：</span>
                      <el-input placeholder="请输入内容" size="small" v-model="pd.radius"   class="input-input"></el-input>
                  </el-col>
                </el-row>
                <el-row type="flex">
                  <el-col :span="24" style="text-align:center;">
                    <el-button type="primary" size="mini" @click="getSearch('leaflet-draw-draw-circle')">查询</el-button>
...
import {createMapL,doSearch} from '@/assets/js/SuperMap/aa.js'
let zdvm;
export default {
    inject:['reload'],
  data(){
